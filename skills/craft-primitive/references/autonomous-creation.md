...
|------|-----------------|-------------|--------|
| **Foundational** | Universal patterns, applies broadly, no explicit trigger | `user-invocable: false` | Add compressed summary to CLAUDE.md |
...
## CLAUDE.md as Passive Knowledge Index

Foundational skills get compressed summaries in CLAUDE.md so their principles
are always in context without requiring invocation. The full skill exists for
deep reference — CLAUDE.md carries the compressed essence.
